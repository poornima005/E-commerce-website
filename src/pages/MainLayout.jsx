...
import hundred from '../images/hundreds.png'
  ...
  return (
    <div>
      ...
      <section className="lg:flex px-10 lg:px-40 h-auto">
        ...
        />
        <div>
          <img src={ele2} alt="" className="p-2 w-full h-[50%]" />
          <img src={ele3} alt="" className="p-2 w-full h-[50%]" />
        </div>
      </section>
      ...
      <section className="relative flex w-full h-[360px] items-center justify-center">
        <div className="absolute inset-0 w-full h-full">
          <img src={news} alt="Drawer" className="w-full h-full" />
        </div>
